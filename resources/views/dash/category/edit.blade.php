...
@section('sub_folder',$category->name)
@section('content')
<form action="{{ route('dash.categories.update', $category) }}" method="POST" enctype="multipart/form-data">
    @csrf @method('PATCH')
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between pb-0">
                    <h5 class="font-weight-bolder mb-0">{{ $category->name }}</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
