        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="number" step="1" min="1" name="min_purchase_qty" value="{{ old('min_purchase_qty') }}"
                        class="form-control">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="number" step="1" min="0" name="max_purchase_qty" value="{{ old('max_purchase_qty') }}"
                        class="form-control">
